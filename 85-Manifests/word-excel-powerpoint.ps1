...
output: word-excel-powerpoint.xml
tag: multi

---#>

param (
  $magicboxWeb = "localhost:1248"
)
...
<OfficeApp xmlns="http://schemas.microsoft.com/office/appforoffice/1.1"
  ...
  <Id>90213477-9a14-4003-beb8-a5b296991c94</Id>
...
Out-File -FilePath (join-path  $workdir "word-excel-powerpoint-local.xml") -InputObject $manifest -Encoding utf8BOM